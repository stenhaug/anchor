...
## The equal means, multiple imputation logit graph (EM-MILG)

AI methods are generally designed to automatically detect DIF without any human judgement. On the other hand, it can be useful to present information to the analyst in a way that empowers them to visualize their data.
