...
Computing is done in R [@rcore], model fitting in the R package mirt [@chalmers2012mirt], and data wrangling/visualization in the set of R packages known as the tidyverse [@tidy]. Code is available at TO DO.
...
### The equal means, multiple imputation logit graph
