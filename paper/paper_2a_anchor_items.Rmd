...
Throughout this paper, we estimate models using marginal maximum likelihood estimation [@bock1981marginal]. In addition, we follow the common and inconsequential practice of identifying the scale by setting $\mu^\text{ref} = 0$. 
